    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    dx.command.findusages.Main.main(without(args, i));
                    break;
